...
<body>
	<div class="container">
		<div class="row text-center header-row jumbotron">
			<h1>Low Fare Flights Search</h1>
		</div>
		<div class="row">
			<!-- left -->
			<div class="col-md-2 left-column">
				<input type="button" class="btn btn-primary"
					onclick="location = '/Orion'" value="Pocetna stranica">
			</div>
			<!-- center -->
				...
				<div class="form-container">
					...
					<form:form method="post" modelAttribute="search"
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-7">
									<form:input path="origin" id="origin" type="text"
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="departureDate">Departure
									Date</label>
								<div class="col-md-7">
									<form:input type="text" path="departureDate" id="departureDate"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="returnDate">Return
									Date</label>
								<div class="col-md-7">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="arriveByDate">Arrive
									By Date</label>
								<div class="col-md-7">
									<form:input type="text" path="arriveByDate" id="arriveByDate"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="returnByDate">Return
									By Date</label>
								<div class="col-md-7">
									<form:input type="text" path="returnByDate" id="returnByDate"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-7">
									<form:input type="text" path="adultsNumber" id="adultsNumber"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-7">
									<form:input type="text" path="childrenNumber"
										id="childrenNumber" class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-7">
									<form:input type="text" path="infantsNumber" id="infantsNumber"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="includeAirlines">Include
									Airlines</label>
								<div class="col-md-7">
									<form:input type="text" path="includeAirlines"
										id="includeAirlines" class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="excludeAirlines">Exclude
									Airlines</label>
								<div class="col-md-7">
									<form:input type="text" path="excludeAirlines"
										id="excludeAirlines" class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="nonStop">Non
									Stop</label>
								<div class="col-md-1">
									<form:checkbox path="nonStop" id="nonStop"
										class="form-control input-sm" />
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="maxPrice">Max
									Price</label>
								<div class="col-md-7">
									<form:input type="text" path="maxPrice" id="maxPrice"
										class="form-control input-sm" />
									<div class="has-error">
					...
					-->
									<form:select path="currency" class="form-control input-sm">
										<form:option value="Select value" />
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="travelClass">Travel
									Class</label>
								<div class="col-md-7">
									<!--  
					<form:input type="text" path="travelClass" id="travelClass" class="form-control input-sm" />
					 -->
									<form:select path="travelClass" class="form-control input-sm">
										<form:option value="Select value" />
										<form:options items="${travelClass}" />
									</form:select>
									<div class="has-error">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label class="col-md-3 control-lable" for="numberOfResults">Max
									Number Of Results</label>
								<div class="col-md-7">
									<form:input type="text" path="numberOfResults"
										id="numberOfResults" class="form-control input-sm" />
									<div class="has-error">
